...
classify_bugs <- function(bugs, dict) {
  if (all(is.na(bugs))) return(NA_character_)
  tibble(
    bug = bugs
  ) %>%
    left_join(dict, by = c("bug" = "organism")) %>%
